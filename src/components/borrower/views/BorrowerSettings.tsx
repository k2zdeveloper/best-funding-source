...
export const BorrowerSettings: React.FC<BorrowerSettingsProps> = ({ userData }) => {
  ...
  if (loading) {
    return <div className="flex justify-center py-20"><Loader2 className="w-8 h-8 text-[#1B6FA5] animate-spin" /></div>;
  }
  ...
  return (
    <div className="animate-in fade-in duration-500 max-w-4xl mx-auto">
      ...
      <form onSubmit={saveSettings} className="space-y-10">
        ...
        <section>
          <h2 className="text-xs font-bold text-slate-400 uppercase tracking-widest mb-4 flex items-center gap-2">
            <EyeOff className="w-4 h-4 text-[#1B6FA5]" /> Marketplace Privacy & Intent
          </h2>
          <div className="bg-white p-6 sm:p-8 rounded-3xl border border-slate-200 shadow-sm space-y-6">
            ...
            <div className="flex flex-col sm:flex-row justify-between sm:items-center gap-4 p-4 bg-slate-50 border border-slate-100 rounded-2xl">
              <div>
                <p className="text-sm font-bold text-slate-900 flex items-center gap-2">
                  ...
                  <span className="px-2 py-0.5 bg-[#21B0A6]/10 text-[#1B6FA5] text-[10px] uppercase rounded-full tracking-wider font-bold">Pro Feature</span>
                </p>
            ...
            <div>
              ...
              <select 
                ...
                className="w-full sm:w-1/2 bg-white border border-slate-200 px-4 py-3 text-sm font-bold text-slate-900 rounded-xl focus:outline-none focus:ring-2 focus:ring-[#21B0A6] cursor-pointer transition-all"
              >
        ...
        <section>
          <h2 className="text-xs font-bold text-slate-400 uppercase tracking-widest mb-4 flex items-center gap-2">
            <Building2 className="w-4 h-4 text-[#1B6FA5]" /> Corporate Details
          </h2>
          <div className="bg-white p-6 sm:p-8 rounded-3xl border border-slate-200 shadow-sm space-y-6">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div>
                ...
                <select 
                  ...
                  className="w-full bg-white border border-slate-200 px-4 py-3 text-sm font-bold text-slate-900 rounded-xl focus:outline-none focus:ring-2 focus:ring-[#21B0A6] cursor-pointer transition-all"
                >
              ...
              <div className="md:col-span-2">
                ...
                <div className="relative max-w-md">
                  ...
                  <input 
                    ...
                    className="w-full bg-white border border-slate-200 pl-11 pr-4 py-3 text-base font-bold text-slate-900 rounded-xl focus:outline-none focus:border-[#21B0A6] focus:ring-2 focus:ring-[#21B0A6]/20 transition-all" 
                  />
                </div>
              </div>
            </div>
        ...
        <section>
          <h2 className="text-xs font-bold text-slate-400 uppercase tracking-widest mb-4 flex items-center gap-2">
            <Bell className="w-4 h-4 text-[#1B6FA5]" /> Notification Routing
          </h2>
          <div className="bg-white p-2 rounded-3xl border border-slate-200 shadow-sm">
            <div className="flex items-center justify-between p-4 sm:p-6 hover:bg-[#1B6FA5]/5 rounded-2xl transition-colors">
              <div>
        ...
        <div className="flex justify-end pt-2 pb-6">
          <button type="submit" disabled={saving} className="px-8 py-3.5 bg-[#21B0A6] text-white text-sm font-bold rounded-xl hover:bg-[#1B6FA5] transition-all flex items-center gap-2 shadow-lg shadow-[#21B0A6]/20 disabled:opacity-50 focus:outline-none focus:ring-2 focus:ring-[#21B0A6] focus:ring-offset-2">
      ...
      <section className="mt-8 pt-10 border-t border-slate-200">
        <h2 className="text-xs font-bold text-slate-400 uppercase tracking-widest mb-4 flex items-center gap-2">
          <ShieldCheck className="w-4 h-4 text-[#1B6FA5]" /> Security & Access Control
        </h2>
        <SecurityControls />
      </section>
