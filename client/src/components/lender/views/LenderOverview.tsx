...
import { ArrowUpRight, TrendingUp, Clock, Briefcase, Star } from 'lucide-react';

// --- ENTERPRISE FIX: Updated TypeScript Interface ---
// We added `onOpenDeal` here so TypeScript knows to expect it from the Dashboard orchestrator.
export const LenderOverview: React.FC<{ 
  userData: any; 
  onOpenDeal: (deal: any) => void; 
}> = ({ userData, onOpenDeal }) => {
  
  // Simulated Data (In production, fetch this from Supabase)
  const activeDeals = [
